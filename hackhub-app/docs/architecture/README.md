...
- Changes the data model or Spring Boot API contract
- Crosses Clean Architecture boundaries (domain / application / infrastructure / presentation)
- Requires a coordinated deploy or Flyway migration
