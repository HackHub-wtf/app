...
public class OrgInvitationController {
    ...
    public OrgInvitationController(CreateOrgInvitationUseCase createOrgInvitationUseCase,
            ...
            RevokeOrgInvitationUseCase revokeOrgInvitationUseCase,
            GetOrgInvitationsUseCase getOrgInvitationsUseCase) {
    ...
    public InvitationResponse createInvitation(@PathVariable UUID id,
        ...
        OrgInvitation invitation = createOrgInvitationUseCase.execute(id, userId,
                request.resolvedRole(), request.invitedEmail());
    ...
    @PreAuthorize("(hasRole('ADMIN') or hasRole('MANAGER')) and @orgSecurity.isOrgOwnerOrManager(#id, authentication)")
    public List<InvitationResponse> listInvitations(@PathVariable UUID id,
            @AuthenticationPrincipal UUID userId) {
        return getOrgInvitationsUseCase.getPending(id, userId)
                .stream()
