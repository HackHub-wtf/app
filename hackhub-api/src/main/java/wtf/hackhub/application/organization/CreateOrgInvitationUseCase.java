...
public class CreateOrgInvitationUseCase {
    ...
    @Transactional
    public OrgInvitation execute(UUID organizationId, UUID callerId,
        ...
        OrgInvitation invitation = new OrgInvitation(organizationId, callerId, token, expiresAt,
                invitedRole, invitedEmail);
